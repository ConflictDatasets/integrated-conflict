...
We develop the actor taxonomies separately for each conflict dataset. The initial recoding process relies on existing research, existing databases, and online resources. We then use the taxonomy developed by @Donnay2019 to standardise actors across datasets. This can be found in the file `summary.rmd`.
...
We base our event taxonomy on @Donnay2019. This file is provided on our OSF page.
